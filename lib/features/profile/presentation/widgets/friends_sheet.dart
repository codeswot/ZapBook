...
class FriendsSheet extends StatefulWidget {
  ...
  static Future<void> show(BuildContext context, {required ContactService contacts}) {
        ...
        children: [
          ...
          if (friends == null)
            ...
            Padding(
              ...
              child: Text('No contacts yet.', style: typography.body.copyWith(color: colors.slate), textAlign: TextAlign.center),
            )
          else
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Text(friend.label, maxLines: 1, overflow: TextOverflow.ellipsis, style: typography.bodyL.copyWith(color: colors.ink)),
                        ...
                        GestureDetector(
                          ...
                          child: Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Text(friend.shortNpub, style: typography.bodyS.copyWith(color: colors.slate)),
